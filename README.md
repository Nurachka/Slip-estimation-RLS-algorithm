...
## Integration into the real robot system



`controllers` folder is a contribution to the beaverbot project, which runs these controllers in the real world. Link to the project: https://github.com/Nurachka/beaverbot.git
