...
file_path = os.path.join(data_dir, 'gerono-cmd_vel_exp4.csv')
#file path for the imu data
file_path_imu = os.path.join(data_dir, 'gerono-imu1_exp4.csv')
...
#print("imu data after converting quaternions to euler angles:", df_imu_filtered.head(10))

#deleting the rows that are before 36.85 sec, because the cmd vel data starts at 12.45 sec
df_imu_filtered = df_imu_filtered[df_imu_filtered['time'] > '2025/07/11/14:09:36.853596']
#deleting the rows after 2025/07/11/14:09:56.508609 because cmd vel stops sending velocity after that
df_imu_filtered = df_imu_filtered[df_imu_filtered['time'] <='2025/07/11/14:09:56.508609']
...
#print("imu data after filtering:", df_imu_filtered.head(10))
...
# #deleting the row  of theta_unwrapped at the index 193, cause there is a discontinuity in the data
df_cmd_synced = df_cmd_synced.drop(index=193)
