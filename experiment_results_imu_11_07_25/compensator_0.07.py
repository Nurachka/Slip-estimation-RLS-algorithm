...
df_modified = compensator.modify_velocities(0.07, df_trajectory)
print("Modified velocities:", df_modified['right_vel'].head(5), df_modified['left_vel'].head(5))

#save the modified dataframe as a csv file
df_modified.to_csv(os.path.join(trajectory_dir, 'lemniscate_trajectory_modified_0.07.csv'), index=False)